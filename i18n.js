...
const TRANSLATIONS = {
    en: {
        ...
        'nutrition.title': 'Optimal Fuel Windows',
        'nutrition.description': 'Best moments to eat/drink based on terrain and timing.',
        'nutrition.logic': 'Avoids steep grades (>8%) where digestion is harder.',
    ...
    de: {
        ...
        'nutrition.description': 'Beste Momente zum Essen/Trinken basierend auf Gelände und Timing.',
        'nutrition.logic': 'Vermeidet steile Abschnitte (>8%) wo Verdauung schwieriger ist.',
