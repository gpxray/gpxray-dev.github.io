...
const TRANSLATIONS = {
    en: {
        ...
        'hero.nutritionWindow': 'Eat Zones',
        'nutrition.title': 'Best Terrain for Eating',
        'nutrition.description': 'Flat/gentle segments where eating is comfortable.',
        'nutrition.logic': 'Terrain with <5% grade for at least 500m.',
    ...
    de: {
        ...
        'hero.nutritionWindow': 'Esszonen',
        'nutrition.title': 'Bestes Gelände zum Essen',
        'nutrition.description': 'Flache/sanfte Abschnitte wo Essen angenehm ist.',
        'nutrition.logic': 'Gelände mit <5% Steigung für mindestens 500m.',
